      ...
      <div className="w-full max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-grow">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-600">Emp Name</label>
                  <input
                    name="empName"
                    value={form.empName}
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-600">Emp No</label>
                  <input
                    name="empNo"
                    value={form.empNo}
                    onChange={handleChange}
            ...
            <div className="flex-shrink-0 lg:w-80">
              <div className="bg-gray-50 rounded-xl p-4 h-32 overflow-hidden">
                <h3 className="text-sm font-semibold text-gray-700 mb-2">Employee Directory</h3>
                <div className="space-y-1 text-xs">
                  {[
                    { id: "4", name: "K.G.D.M.S", surname: "MAHANAMEWITA GAMAGE DONA" },
        ...
        <div className="bg-white rounded-xl shadow-lg mb-6 p-1">
          <div className="flex flex-wrap gap-1">
            {["Personal", "Address", "Organization", "Compensation", "Salary"].map((tab, index) => (
              <button
                key={tab}
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800">Address And Contact Details</h2>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <label className="block text-sm font-medium text-gray-700">Electoral Division</label>
                    <input
